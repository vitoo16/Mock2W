  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-white to-blue-200 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <motion.div
        ...
        className="max-w-md w-full space-y-8 bg-white/95 p-10 rounded-[2rem] shadow-xl border border-blue-100 backdrop-blur-sm"
      >
        <motion.div
        ...
        >
          ...
          <p className="mt-2 text-gray-600 text-sm">
            Sign in to continue to TaskMaster Pro
          </p>
        </motion.div>
        ...
        {error && (
          <motion.div
            ...
            className="bg-red-50 border-l-4 border-red-500 text-red-700 p-4 rounded-xl flex items-center"
          >
